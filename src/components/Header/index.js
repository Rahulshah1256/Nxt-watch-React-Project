    ...
    <nav className="navbar-header" style={{ backgroundColor: bgColor }}>
      ...
      <div className="actions-container">
        ...
        <Popup
          modal
          trigger={
            <button type="button" className="logout-button" style={{ backgroundColor: bgColor, color }}>
              Logout
            </button>
          }
        >
          {close => (
            <div className="modal-container">
              ...
              <div className="buttons-container">
                ...
                <button type="button" className="confirm-button" onClick={onClickLogout}>
                  Confirm
                </button>
              </div>
            </div>
        ...
        <Popup
          modal
          trigger={<button type="button" className="logout-icon-button"><FiLogOut size={25} color={color} /></button>}
